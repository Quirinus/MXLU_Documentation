	...
	*/
	...
	var classnames_readable = new Array("", "Амазонка","Ассассин","Варвар","Друид","Некромант","Паладин","Колдунья");
	var skillnames;
	...
	function changeName()
	{
		var a = "Планировщик навыков для Median XL",
	...
	function save()
	{
		...
		j = k + "?" + b;
		f = "План навыков " + cname + " (" + classnames_readable[classnr] + ", " + CURRENT_PATCH_READABLE + ")";
		set("save_url", f);
		...
		if (window.location.href.indexOf('mxl.vn.cz') === -1)
		{
			...
			j = k + "?" + b;
			f = "Оффлайн план навыков " + cname + " (" + classnames_readable[classnr] + ", " + CURRENT_PATCH_READABLE + ")";
