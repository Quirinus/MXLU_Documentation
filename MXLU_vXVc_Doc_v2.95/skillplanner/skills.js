	...
	*/
	...
	skillnames_uxvc[1]=new Array("",Array("Sun Strike",2,true),"Barrage","Phalanx","Dragonlore","Wyrmshot","Moonbeam","Ricochet","Enfilade","Moon Queen","Fairy Ring","Takedown","Hyena Strike","Pounce","Lioness",Array("Great Hunt",2,true),"Magic Missiles","Balefire","Bloodstorm","Bacchanalia","Lava Pit", "Thundercrack", "Stormcall", "Hammer of Zerae", "Asterism", "Magnetic Field", "Wild and Free","Summon Fire Elementals","Balance",Array("Ecstatic Frenzy",2,true),"Defensive Harmony","Curare","Paragon","Spirit of Vengeance","Spellbind",Array("War Spirit",2,true));
	...
	skillnames_uxvc[3]=new Array("",Array("Earthquake",2,true), "Iceburst","Thunder Slam","Shower of Rocks",Array("Stormblast",2,true),"Bloodhatred", "Iron Spiral", "Deathgaze", "Daedalus", "Windform","Bear Claw","Stampede","Rebound","Screaming Eagle","Overkill","Guardian Spirit","Defender Spirit","Protector Spirit","Greater Manifestations","Spirit Walk","Wolf Companion","Ancient Blood","Fortress","Spirit Guide","Mountain King","Lion Stance","Snake Stance","Bear Stance","Eagle Stance","Wolf Stance","Nephalem Weapons","Runemaster","Shamanic Trance","Immortal","Thundergod");
	...
	var skillnames_uxvi=new Array();
	skillnames_uxvi[1]=new Array("",Array("Sun Strike",2,true),"Barrage","Phalanx","Dragonlore","Wyrmshot","Moonbeam","Ricochet","Enfilade","Moon Queen","Fairy Ring","Takedown","Hyena Strike","Pounce","Lioness",Array("Great Hunt",2,true),"Magic Missiles","Balefire","Bloodstorm","Bacchanalia","Lava Pit", "Thundercrack", "Stormcall", "Hammer of Zerae", "Asterism", "Magnetic Field", "Wild and Free","Summon Fire Elementals","Balance",Array("Ecstatic Frenzy",2,true),"Defensive Harmony","Curare","Paragon","Spirit of Vengeance","Spellbind",Array("War Spirit",2,true));
	skillnames_uxvi[2]=new Array("",Array("Batstrike",2,true),"Crucify", "Shadow Dancer","Barrier Strike", "Noctule","Scorpion Blade","Storm Crows","Wychwind","Maelstrom5","Broadside", "Backstab","Shadow Refuge","Twin Fang Strike","Laserblade","Hades Gate","Blink","Way of the Spider","Queen of Blades","Way of the Phoenix","Perfect Being", "Obliteration","Shuriken Flurry",Array("Psionic Storm",3,true),"Singularity","Doom","Cluster Mine","Limpet Laser",Array("Electrofield Sentry",2,true),Array("Fireball Sentry",2,true),"Tiefling Form","Beacon","Way of the Gryphon","Phase Bomb","Vampiric Icon","Psychic Scream");
	skillnames_uxvi[3]=new Array("",Array("Earthquake",2,true), "Iceburst","Thunder Slam","Shower of Rocks",Array("Stormblast",2,true),"Bloodhatred", "Iron Spiral", "Deathgaze", "Daedalus", "Windform","Bear Claw","Stampede","Rebound","Screaming Eagle","Overkill","Guardian Spirit","Defender Spirit","Protector Spirit","Greater Manifestations","Spirit Walk","Wolf Companion","Ancient Blood","Fortress","Spirit Guide","Mountain King","Lion Stance","Snake Stance","Bear Stance","Eagle Stance","Wolf Stance","Nephalem Weapons","Runemaster","Shamanic Trance","Immortal","Thundergod");
	skillnames_uxvi[4]=new Array("",Array("Treewarden Form",2,true),"Pummel","Wildfire","Circle of Life","Idol Of Scosglen","Trap Rat Form","Quill Storm","Egg Trap","Ferocity","Thorn Wall","Werewolf Form", "Mana Pulse", "Harbinger", "Feed the Pack", "Twisted Claw","Elemental","Hunting Banshee","Pagan Rites","Rain of Fire",Array("Freezing Gale",2,true),Array("Poison Flash",2,true),"Elvensong","Plague Avatar",Array("Mythal",2,true),"Summon Acid Fiends","Laughing Ghost","Cascade","Spore Shot","Elfin Weapons","Nova Shot","Force of Nature","Faerie Fire","Tremor","Goodberry","Lifeshield");
	skillnames_uxvi[5]=new Array("","Deaths Fury Totem","Frostclaw Totem","Fireheart Totem","Howling Totem","Stormeye Totem","Embalming","Sacrifices","Bend the Shadows","Bane","Talons Hold","Summon Shadows","Summon Rampagor","Summon Lamia","Summon Veil King","Summon Void Archon","Boneyard", "Funeral Pyre", "Rotting Flesh", "Nightwalker", "Pestilence","Massacre","Angel of Death","Famine","Parasite","Deathlord","Buckshot","Flametail Shot","Dragonfire Oil","Fragmentation Shot","Voodoo Shot","Summon Jinn","Rathmas Chosen","Death Ward","Black Mass","Graveyard");
	skillnames_uxvi[6]=new Array("","Retaliate","Hammerstrike","Plague","Dragonheart","Colosseum","Vessel of Retribution","Rapture",Array("Solstice and Equinox",16,false),Array("Sacred Armor",2,true), "Hoplite","Solar Flare","Drakemaw","Frozen Breath",Array("Incarnation",51,false),"Dragon Wyrms","Terror Strike","Lemures",Array("Black Sleep",2,true),"Blood Thorns","Hymn","Vessel of Judgement", "Euphoria", "Life and Death", "Demiurge","Scourge","Tainted Blood","Mind Flay","Symphony Of Destruction","Slayer","Stormlord","Superbeast",Array("Dragonknight",47,false),"Resurrect","Divine Apparition","Blessed Life");
	skillnames_uxvi[7]=new Array("","Flamefront","Living Flame","Flamestrike","Pyroblast","Firedance","Forked Lightning","Thunderstone","Tempest","Warp Armor",Array("Nova Charge",2,true),"Shatter the Flesh",Array("Frigid Sphere",2,true),"Snow Queen","Abyss","Summon Ice Elementals","Lorenado","Vengeful Power","Miasma","Carpet of Spiders","Hive",Array("Immersion",11,false),"Familiar",Array("Arcane Torrent",2,true),"Mana Sweep", "Antimass","Moonstrike","Wraithsword", "Fusillade", "Summon Blade Spirits",Array("Bladestorm",2,true),Array("Chronofield",2,true),Array("Witch Blood",2,true),"Baneblade","Symbol of Esu","Force Blast");