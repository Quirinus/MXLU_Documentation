	...
	*/
	...
	skillnames_uxvc[1]=new Array("",Array("Sun Strike",2,true),"Barrage","Phalanx","Dragonlore","Wyrmshot","Moonbeam","Ricochet","Enfilade","Moon Queen","Fairy Ring","Takedown","Hyena Strike","Pounce","Lioness",Array("Great Hunt",2,true),"Magic Missiles","Balefire","Bloodstorm","Bacchanalia","Lava Pit", "Thundercrack", "Stormcall", "Hammer of Zerae", "Asterism", "MagneticField", "Wild and Free","Summon Fire Elementals","Balance",Array("Ecstatic Frenzy",2,true),"Defensive Harmony","Curare","Paragon","Spirit of Vengeance","Spellbind",Array("War Spirit",2,true));
